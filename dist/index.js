...
var _keymirror = __webpack_require__(83);
...
var _authStore = __webpack_require__(85);
...
var _AuthLogin = __webpack_require__(82);

var _AuthLogin2 = _interopRequireDefault(_AuthLogin);

var _AuthSignup = __webpack_require__(84);
...
var Auth = function (_Component) {
    ...
    _createClass(Auth, [{
        ...
        value: function componentWillMount() {
            _Http2.default.setBaseURL(this.props.baseUrl);
            _Http2.default.setHeaders({
                'content-type': 'application/json',
        ...
        value: function render() {
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement(_reactRouter.Route, { location: this.props.location, exact: true, path: '/', render: function render() {
                        return _react2.default.createElement(_AuthLogin2.default, _this2.props);
                    } }),
    ...
    _createClass(Login, [{
        ...
        value: function _handleEnterPress(e) {
            if (e.key === "Enter") {
                ...
                this.props.loginUser({ email: email, password: password }, this.props.onLoginSuccess, this.props.onLoginFail);
            }
        }
    }, {
        key: 'render',
        value: function render() {
            return _react2.default.cloneElement(this.props.login, this.props);
        }
    }]);
...
exports.default = (0, _reactRedux.connect)(mapStateToProps, { inputChanged: _authAction.inputChanged, loginUser: _authAction.loginUser, isUserInLocalStorage: _authAction.isUserInLocalStorage })(Login);
...
var _immutabilityHelper = __webpack_require__(87);
